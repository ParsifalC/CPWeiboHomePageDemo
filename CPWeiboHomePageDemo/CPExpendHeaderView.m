...
- (void)transformUpdateWithOffset:(CGPoint)newOffset
{
    ...
    if (newOffset.y <= 0) {
        ...
        CGFloat originHeight = CGRectGetHeight(self.collectionView.bounds);
        CGFloat scaleFactor = fabs(newOffset.y)*2/originHeight+1;
        CGAffineTransform scale = CGAffineTransformMakeScale(scaleFactor, scaleFactor);
        CGAffineTransform composeTransform = CGAffineTransformConcat(scale, translate);
